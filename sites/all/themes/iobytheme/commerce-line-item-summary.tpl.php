 ...
 */
?>
<?php if (!$total) { ?><a href="/cart" rel="nofollow"><?php } ?><div class="line-item-summary">
  <?php if ($total) { print $links; } else { ?>
  <ul class="links inline"><li class="line-item-summary-view-cart first last"><span class="cart-link">cart</span></li>
  </ul><?php } ?>
  <?php if ($quantity_raw): ?>
