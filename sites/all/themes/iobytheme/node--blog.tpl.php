...
$blog_url = db_select('feeds_item', 'f')->fields('f', array('url'))->condition('f.entity_id', $node->nid, '=')->execute()->fetchField();
...
<?php if ($user_picture || !$page || $display_submitted): ?>
  <header>
    ...
    <?php if (!$page): ?>
      <h3<?php print $title_attributes; ?>><a href="<?php print $blog_url; ?>"><?php print $title; ?></a></h3>
    <?php endif; ?>
