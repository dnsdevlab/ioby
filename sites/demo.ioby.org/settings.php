 ...
 *
 */
$drupal_hash_salt = 'J83ffo8-xicW87IHs6F8_CkraqejOAe3lS3RZcT2B2M';
...
//  $conf['googlemap_api_key'] = 'ABQIAAAAUOdYBjivmUhoF1qNa1z-xBQJwvAq2Fb7h-zrrPEIylly_3PS5RQ1FjRgpoJZvhOQHOATVkPYROhdfQ';
//} else if (stripos($_SERVER['HTTP_HOST'],'ioby.org') !== false) {
//  $conf['googlemap_api_key'] = 'ABQIAAAAUOdYBjivmUhoF1qNa1z-xBQtfAm92SLsgpUxCm9kEX4tuOrFKhRErXWTc7b8LAAckZ_44ymJw1ZWFw';
//} else if (stripos($_SERVER['HTTP_HOST'],'64.207.153.127') !== false) {
//  $conf['googlemap_api_key'] = 'ABQIAAAAUOdYBjivmUhoF1qNa1z-xBQpT4_gsyBpAZTPx2JWAbWF3cT5chRIWHqoyyGpi6JmGUphIX25G-RedA';
//}
...
// Mixed HTTP and HTTPS sessions
$conf['https'] = FALSE;

/*$conf['devel_debug_mail_directory'] = 'public://devel-mails';
$conf['mail_system']['default-system'] = 'DevelMailLog';*/

$conf['devel_mail_log_enabled'] = 1;
$conf['mail_system'] = array('default-system' => 'DevelMailSystem');
$conf['devel_mail_log_send_enabled'] = 0;

$conf['securepages_basepath'] = '';
$conf['securepages_basepath_ssl'] = '';
//$conf['cron_safe_threshold'] = "0";

$conf['ioby_salesforce_username'] = '';
$conf['ioby_salesforce_password'] = '';
$conf['ioby_salesforce_token'] = '';

if (file_exists(DRUPAL_ROOT . '/sites/demo.ioby.org/salesforce-settings.inc')) {
  // This file shouldn't be in source control and should contain the salesforce variables from above
  require(DRUPAL_ROOT . '/sites/demo.ioby.org/salesforce-settings.inc');
}
